...
/*
	...
	public List<NewAdvertisementPostResponse> searchByCriteria(@RequestBody FilterCriteriaRequest criteriaRequest ){
	...
	*/
	//api-14
	@GetMapping("advertise/search/{search}")
	public List<NewAdvertisementPostResponse> searchPosts(@PathVariable(name = "search") String searchText) {
		List<AdvertisementPost> allPosts = this.service.getAllAdvertisementPosts();
